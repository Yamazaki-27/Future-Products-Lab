...
```text
KB/Knowledge/AGV/MagneticTape.md
KB/Knowledge/AMR/SLAM.md
KB/Knowledge/Vision/CameraAI.md
```
...
企業名・出展社名が出てきた場合、`KB/Companies/企業名.md` を作成・更新する。
...
```text
KB/Ideas/AGV_next_generation.md
KB/Ideas/Lift_AI_maintenance.md
```
...
|---|---|---|
| `KB/Knowledge/カテゴリ/ファイル.md` | `../../../Reports/展示会フォルダ/Images/` | `../../../Reports/展示会フォルダ/Images/OtherPictures/` |
| `KB/Companies/企業名.md` | `../../Reports/展示会フォルダ/Images/` | `../../Reports/展示会フォルダ/Images/OtherPictures/` |
| `KB/Trends/年.md` | `../../Reports/展示会フォルダ/Images/` | `../../Reports/展示会フォルダ/Images/OtherPictures/` |
| `KB/Ideas/アイデア名.md` | `../../Reports/展示会フォルダ/Images/` | `../../Reports/展示会フォルダ/Images/OtherPictures/` |
...
- 4カテゴリ（KB/Knowledge・KB/Companies・KB/Trends・KB/Ideas）それぞれの現存 `.md` ファイルを `find` で列挙し、テーブル形式でリンクを生成する。
- ファイルは `KB/Knowledge/AMR/*.md` のようにカテゴリ名を先に表示し、ファイル名は日本語タイトルに変換できる場合は変換する。
...
| カテゴリ | ファイル | 概要 | 最終更新 |
|---|---|---|:---:|
| AMR | [ファイルタイトル](KB/Knowledge/AMR/Commoditization.md) | 概要（1行）| 2026-07-02 |
```
...
| 企業名 | ファイル | 関係性 | 最終更新 |
|---|---|---|:---:|
| 企業名 | [企業名.md](KB/Companies/企業名.md) | 担当・関係性 | 2026-07-02 |
```
...
| ファイル | 内容 | 最終更新 |
|---|---|:---:|
| [タイトル](KB/Trends/ファイル.md) | 概要（1行）| 2026-07-02 |
```
...
| ファイル | アイデア概要 | 最終更新 |
|---|---|:---:|
| [タイトル](KB/Ideas/ファイル.md) | 概要（1行）| 2026-07-02 |
```
