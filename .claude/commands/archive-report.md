...
- OtherPictures/ も含めて再検索する
- それでも不足する場合は、ある分だけ挿入し、無理に3枚に合わせない
- **関係のない写真を水増しのために使わない**
...
|---|---|---|
| `Knowledge/カテゴリ/ファイル.md` | `../../展示会フォルダ/Images/` | `../../展示会フォルダ/Images/OtherPictures/` |
| `Companies/企業名.md` | `../展示会フォルダ/Images/` | `../展示会フォルダ/Images/OtherPictures/` |
| `Trends/年.md` | `../展示会フォルダ/Images/` | `../展示会フォルダ/Images/OtherPictures/` |
| `Ideas/アイデア名.md` | `../展示会フォルダ/Images/` | `../展示会フォルダ/Images/OtherPictures/` |
...
| カテゴリ | ファイル | 概要 | 最終更新 |
|---|---|---|:---:|
| AMR | [ファイルタイトル](Knowledge/AMR/Commoditization.md) | 概要（1行）| 2026-07-02 |
```
...
| 企業名 | ファイル | 関係性 | 最終更新 |
|---|---|---|:---:|
| 企業名 | [企業名.md](Companies/企業名.md) | 担当・関係性 | 2026-07-02 |
```
...
| ファイル | 内容 | 最終更新 |
|---|---|:---:|
| [タイトル](Trends/ファイル.md) | 概要（1行）| 2026-07-02 |
```
...
| ファイル | アイデア概要 | 最終更新 |
|---|---|:---:|
| [タイトル](Ideas/ファイル.md) | 概要（1行）| 2026-07-02 |
```
...
|---|---|---|:---:|:---:|
| 2026年4月13日 | [🇺🇸 米国／MODEX 2026...](202604-MODEX/Report.md) | 山崎・橋本GM | 111枚・15.0MB | [7/2](archive_log.md) |
```
